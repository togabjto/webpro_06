...
// ★追加：データが存在しない場合は処理を中断して一覧に戻す⭐️
  ...
  brand2[req.params.number].type1 = req.body.type1;
  brand2[req.params.number].type2 = req.body.type2;
  brand2[req.params.number].name = req.body.name;
  brand2[req.params.number].change = req.body.change;
  brand2[req.params.number].passengers = req.body.passengers;
  brand2[req.params.number].distance = req.body.distance;
  console.log( brand2 );
  res.redirect('/brand2' );
});
